...
var survey_block = {
   type: 'survey-text',
   data: {
       trial_id: "survey questions"
   },
   questions: [
        '<p class = center-block-text style = "font-size: 20px">identifiant expérimentateur.</p>',
              '<p class = center-block-text style = "font-size: 20px">identifiant participant</p>'
      ],
   rows: [5, 5],
   columns: [60,60]
};
...
go_nogo_experiment.push(survey_block);
